...
describe('Create condition on multiple choice question in clause library', () => {
    before(() => {
                            ...
                            it('Clauses WITH numbering', () => {
                                for (let i = 0; i < clausesData.artWithNum.length; i++) {
                                    ...
                                    conditions.createCond(condition.objectName,
                                        questionData.multipleChoice.templateCl,
                                        questionData.multipleChoice.systemNameCl,
                ...
                case 2: {
                    ...
                    describe('DOCUMENT EDITOR', () => {
                        ...
                        it('Check if condition met & download', () => {
                            clauses.changeClauseVisibility(templateID.question, clause[0], questionData.multipleChoice.clauseTextCl);
                            for (let i = 0; i < clausesData.artWithNum.length; i++) {
                                clauses.checkClause(
                                    templateID.clauses,
                                    clause[i],
                    ...
                    describe('DOCUMENT EDITOR', () => {
                        ...
                        it('Check if condition met & download pdf', () => {
                            ...
                            elements.answerQuestionMultiChoice(templateID.question,
                                questionData.multipleChoice.questionNameCl,
